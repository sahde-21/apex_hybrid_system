...
<head>
    <meta charset="utf-8">
    <title>{{ __('scf.sale_orders') }} {{ $record->reference_number }}</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .doc-type { font-size: 24px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; color: #334155; }
...
<div class="sheet">
    <div class="brand">
        ...
        <div class="doc-type">{{ __('scf.sale_orders') }}</div>
    </div>
    ...
    <div class="meta">
        ...
        <div class="box">
            ...
            <p>{{ __('scf.delivery') }}: {{ $record->delivery_date?->format('Y-m-d') ?? '—' }}</p>
