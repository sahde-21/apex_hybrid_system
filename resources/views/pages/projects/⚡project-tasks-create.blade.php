...
new #[Title('Create Project tasks')] class extends Component {
    ...
    {
        $validated = $this->validate($this->projectTaskRules());

        ProjectTask::query()->create($validated);

        Flux::toast(variant: 'success', text: __('Project tasks created successfully.'));
...
<section class="w-full">
    <div class="mb-6">
        <flux:heading size="xl">{{ __('Create Project tasks') }}</flux:heading>
    </div>
