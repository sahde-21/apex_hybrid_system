...
new #[Title('Create Stock transfers')] class extends Component {
    ...
    public function save(): void
    {
        ...
        StockTransfer::query()->create($validated);

        Flux::toast(variant: 'success', text: __('Stock transfers created successfully.'));
...
<section class="w-full">
    <div class="mb-6">
        <flux:heading size="xl">{{ __('Create Stock transfers') }}</flux:heading>
    </div>
