...
new #[Title('Create purchase order')] class extends Component {
    ...
    public function save(): void
    {
        ...
        try {
            $order = app(PurchaseOrderWorkflowService::class)->create(auth()->user(), [
            ...
            Flux::toast(variant: 'success', text: __('scf.purchase_workflow.order_created'));
...
<section class="scf-page">
    <div class="mb-6 flex items-start justify-between">
        <div>
            ...
            <flux:subheading>{{ __('Record a new supplier purchase order') }}</flux:subheading>
        </div>
