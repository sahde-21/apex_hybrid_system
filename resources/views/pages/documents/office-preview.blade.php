...
<body class="min-h-screen bg-zinc-50 antialiased dark:bg-zinc-950">
    <main class="mx-auto flex min-h-screen max-w-lg items-center px-4 py-10">
        <div class="portal-glass w-full rounded-2xl p-6">
            <p class="text-sm text-sky-600">{{ __('scf.dms.office_preview_title') }}</p>
            ...
            <p class="mt-4 text-sm text-zinc-600 dark:text-zinc-300">{{ __('scf.dms.office_preview_hint') }}</p>
            <a href="{{ route('documents.download', $document) }}" class="mt-6 inline-flex w-full items-center justify-center rounded-xl bg-sky-600 px-4 py-3 font-medium text-white">
