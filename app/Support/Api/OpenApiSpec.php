    ...
    public static function build(): array
    {
        ...
        return [
            ...
            'paths' => array_merge(
                ...
                self::resourcePaths('warehouses', 'Warehouses', ['warehouses.read'], ['warehouses.write']),
                self::resourcePaths('employees', 'Employees', ['employees.read'], ['employees.write']),
                self::resourcePaths('pos-registers', 'POS Registers', ['pos_registers.read'], ['pos_registers.write']),
                self::resourcePaths('pos-shifts', 'POS Shifts', ['pos_shifts.read'], ['pos_shifts.write']),
                self::resourcePaths('accounts', 'Chart of Accounts', ['accounting.read'], ['accounting.write']),
                self::resourcePaths('branches', 'Branches', ['branches.read'], ['branches.write']),
