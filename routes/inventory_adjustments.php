...
Route::middleware(['auth', 'verified'])->prefix('inventory')->group(function () {
    Route::middleware(['can:inventory-adjustments.read'])->name('inventory-adjustments.')->group(function () {
        ...
        Route::livewire('inventory-adjustments/{inventoryAdjustment}/edit', 'pages::inventory.inventory-adjustments-edit')->middleware('can:inventory-adjustments.read')->name('edit');
